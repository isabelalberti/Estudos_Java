...
// </editor-fold>
		...
		// Passo 1: usuario digitar tempo gasto da viagem e a velocidade média
		
		Double tempo = readWindowDouble("Qual o tempo gasto da viagem em horas?");
		Double velocidade = readWindowDouble("Qual a velocidade media durante a viagem?");
		
		// Passo 2: Calcular a distancia
		
		Double distancia = tempo * velocidade;
		
		// Passo 3: Calcular quantidade de litros
		
		Double litros = distancia/12;
		
		// Passo 4: visualizar resultado
		
		writeWindow("A quantidade de litros utilizado nesta viagem foi de: " + litros);
