...
// </editor-fold>
		...
		// Passo 1: Usuario digitar variavel A e B
		Double a = readWindowDouble("Digite um valor para A");
		Double b = readWindowDouble("Digite o valor para B");

		// Passo 2: trocar os valores das variaveis
		Double c = a;
		a = b;
		b = c;

		// Passo 3: exibir as variaveis
		writeWindow(
				"Valores após efetivação do processamento da troca:" +
				  "\n A: " + a +
				  "\n B: " + b	
		);
