...
public class aritmetricabasica {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		// Passo 1: Leia dois valores numéricos reais desconhecidos representados pelas variáveis A e B.
		// Passo 2: Calcular quatro operações aritméticas básicas.
		// Passo 3: Apresentar os resultados das quatro operações aritméticas básicas.
		...
		writeWindow("O resultado das operações aritmética são:"
				+ "\n Soma: " + sm
				+ "\n Multiplicação: " + mult
				+ "\n Subtração: " + sub
				+ "\n Divisão: " + div);
