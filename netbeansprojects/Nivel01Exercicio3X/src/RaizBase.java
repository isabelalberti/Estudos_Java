...
// </editor-fold>
		...
		// Passo 1: Calcule uma raiz de base.
		// Passo 2: Utilize um índice qualquer.
		
		Double val = readWindowDouble("Digite um numéro para calculo da raiz");
		Double in = readWindowDouble("Digite um índice para calculo da raiz");
		Double result = Math.pow(val, 1/in);
		
		writeWindow("O valor da raiz desta base é de: " + result);
