...
public class ExercicioR_While_parteFinal {
...
// </editor-fold>
		...
		while (numPos >= 0) {
			numPos = readInteger("Digite um valor qualquer");
...
// qualquer numero que eu digitar vai ser menor
// qualquer valor vai ser maior
		// Your code ends here :(
