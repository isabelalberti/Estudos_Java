...
public class ExercicioQ_While_parte1 {
...
// </editor-fold>
		...
		Passo 1: Solicitar a entrada do nome, 
		         da largura 
		         e do comprimento de um determinado cômodo. 
		
		*/
		
		String nomeComodo = readString("Digite o nome do cômodo que quer medir");
		Integer largura = readInteger("Qual a largura deste cômodo?");
		Integer comprimento = readInteger("Qual o comprimento deste cômodo?");
