...
public class ExercicioQ_While_parteFinal {
...
// </editor-fold>
		...
		/*
		Passo 4: Gerar a confirmação de continuar calculando novos cômodos
		Atenção: Caso o usuário responda "NÃO", apresentar o valor acumulado da área.
		
		Passo 5 : Apresentar a área do cômodo lido 
		
		Passo 6: Calcular o valor total acumulado da área residencial
		...
		do {
			//write("Estou repetindo");

			nomeComodo = readString("Digite o nome do cômodo que quer medir");
			largura = readDouble("Qual a largura deste cômodo?");
			comprimento = readDouble("Qual o comprimento deste cômodo?");
			area = largura * comprimento;

			write("O valor da área do " + nomeComodo + " é de: " + "\n" + area);
			soma = soma + area;
			opcao = readString("Deseja continuar calculando cômodos? Digite 'n' para não e 's' para sim");

		}while (!opcao.equals("n"));
		write("A soma total das áreas dos cômodos é de : " + soma);
