...
public class ExercicioQ_While_parte3 {
...
// </editor-fold>
		...
		/*
		Passo 3: Calcular a área total em metros de uma residência 
		
		Atenção; Com os cômodos sala, 
		cozinha,
		banheiro, 
		quarto1,
		quarto2,
		...
		*/
		...
		String nomeComodo = readString("Digite o nome do cômodo que quer medir");
		Double largura = readDouble("Qual a largura deste cômodo?");
		Double comprimento = readDouble("Qual o comprimento deste cômodo?");
