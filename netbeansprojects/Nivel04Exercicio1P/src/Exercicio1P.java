...
// </editor-fold>
		...
		/*
		Leia 12 elementos inteiros para uma matriz A de uma dimensão do tipo vetor. 
		
		Construir uma matriz B de mesmo tipo e dimensão
		
		"todo elemento da matriz A que for ímpar deve ser multiplicado por 2; 
		caso contrário, o elemento da matriz A deve permanecer constante". 
		...
		*/
		...
		for (int i = 0; i < 12; i++) {
			arrayA[i] = readInteger("Digite um valor para A");
						
		}
		
		Integer[] arrayB = new Integer [12];
