...
public class DiferencaValorPositivo {
...
// </editor-fold>
		...
		/*
		Passo 1: Leitura de um valor numérico inteiro positivo ou negativo (variável N)
		Passo 2: Apresentar o valor lido como sendo positivo. 
		Atenção: Dica: se o valor lido for menor que zero, ele deve ser multiplicado por –1.
		*/
		
		Integer n = readWindowInteger("Digite um valor positivo ou negativo");
		...
		writeWindow("O valor numerico positivo é: " + result );
