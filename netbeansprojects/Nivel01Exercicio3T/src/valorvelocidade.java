...
// </editor-fold>
	...
	// Passo 1: Calcule o valor da velocidade de um projétil em metros por segundo.
	// Passo 2: Apresente em metros por segundo o valor da velocidade de um projétil que percorre uma distância em quilômetros a um espaço de tempo em minutos. 
	// Atenção: Utilize a fórmula VELOCIDADE ← (DISTÂNCIA * 1000) / (TEMPO * 60).
	// Atenção: Distância em quilômetros.
	// Atenção: Espaço de tempo em minutos.
		
		Double dis = readWindowDouble("Qual a distancia percorrida pelo projétil?");
		Double temp = readWindowDouble("Qual o tempo que ele percorreu a distancia?");
		
		Double vel = (dis * 1000) / (temp * 60);
	
		writeWindow("A velocidade do projétil em m/s² foi de: " + vel );
