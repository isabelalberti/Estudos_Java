...
public class TestesNivel02 {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
		Integer idadePessoaQueQuerEntrar = readWindowInteger("Qual sua idade? ");
		
		final Integer IDADE_LIMITE = 18;
		
		if (idadePessoaQueQuerEntrar >= IDADE_LIMITE){
			writeWindow("Seja bem-vindo, aproveite a festa =} ");
		}
		else {
			writeWindow(
					"Ah que pena, você não pode entrar hoje!" +
			        "\n      Fica para uma próxima! S2");
		}
