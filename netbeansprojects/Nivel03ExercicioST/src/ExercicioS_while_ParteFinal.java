...
public class ExercicioS_while_ParteFinal {
...
// </editor-fold>
		...
		/*
	Passo 1: Criar as variáveis Quociente, Divisor e Dividendo.
	Passo 2: Ler números para dividendo e divisor.
	Passo 3: Fazer a divisão desses números
	Passo 4: Apresente o resultado inteiro da divisão
	
	Atenção: não utilize o operador aritmético de divisão com quociente inteiro DIV. 
		
		 */
		Integer quociente, dividendo, divisor;

		dividendo = readInteger("Digite o valor do número que gostaria de dividir");
		divisor = readInteger("Digite o valor do divisor");
		quociente = 0;
		...
		write("O resultado inteir do quociente é: " + quociente);
