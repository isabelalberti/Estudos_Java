...
// </editor-fold>
	...
	// Passo 1: Elaborar um programa que leia quatro valores numéricos inteiros (vars A, B, C e D). 
	// Passo 2: Criar variavel do produto (do primeiro com o terceiro valor,) 
	// Passo 3: Criar variavel da soma do segundo com o quarto valor.
	// Passo 4: Ao final o programa deve apresentar o resultado
	

	Integer a = readWindowInteger("Digite um valor para A");
	Integer b = readWindowInteger("Digite um valor para B");
	Integer c = readWindowInteger("Digite um valor para C");
	Integer d = readWindowInteger("Digite um valor para D");
	
	Integer prod = a * c;
	
	Integer soma = b + d;
	
		writeWindow("O produto resultado de A e C é: " + prod +
		"\n O resultado da soma de B e D é: " + soma);
