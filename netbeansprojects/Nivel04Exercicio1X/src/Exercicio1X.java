...
// </editor-fold>
		...
		/*
		Leia uma matriz A de uma dimensão com seis elementos do tipo real.
		Construir uma matriz B
		Cada posição de índice ímpar da matriz B deve ser atribuída com um elemento de índice par existente na matriz A 
		Cada posição de índice par da matriz B deve ser atribuída com um elemento de índice ímpar existente na matriz A.
