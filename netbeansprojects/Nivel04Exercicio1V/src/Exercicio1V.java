...
// </editor-fold>
		...
		/*
		Leia uma matriz A de uma dimensão do tipo vetor com 30 elementos 
		...
		*/
		...
		for (int i = 0; i < arrayA.length; i++) {
			arrayA[i] = readInteger("Digite o " + (i + 1) + "º valor de A");
		...
		String mgs = "Total de valores Pares";
		String mgs1 = "Total de valores Impares";
		
		System.out.println("Valores da Array A são: \n ");
