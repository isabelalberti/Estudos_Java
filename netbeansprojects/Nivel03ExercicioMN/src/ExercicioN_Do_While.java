...
public class ExercicioN_Do_While {
...
// </editor-fold>
		...
		/*
	Leia sucessivamente valores numéricos 
	Apresente no final o somatório, a média e o total de valores lidos.
		
	Atenção: O programa deve ler os valores enquanto o usuário estiver fornecendo valores positivos. 
		...
		*/
		...
		while (cont < 10) {
			num= readDouble("Digite um número");
			soma = soma + num;
		...
		write("O valor da soma foi de: " + soma + "\n"
		+ "O valor da média desses números foi de:" + media);
