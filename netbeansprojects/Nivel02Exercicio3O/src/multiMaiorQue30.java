...
// </editor-fold>
		...
		/*
		Ler um número inteiro qualquer 
		multiplicá-lo por dois. 
		Apresentar o resultado da multiplicação somente se o resultado for maior que 30.
		*/
		
		Integer num1 = readInteger("Digite um número inteiro qualquer");
		Integer result = num1 * 2;
		
		if (result > 30) {
			write("O resultado da multiplicação foi de: " + result);
		}
