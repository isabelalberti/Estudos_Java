...
// </editor-fold>
		...
		/*
		Passo 1: Ler cinco valores numéricos inteiros (variáveis A, B, C, D e E)
		Passo 2: Identificar o maior e o menor valor informado 
		Passo 3: Apresentar o maior e o menor valor informado 
		
ATENÇÃO: Não execute a ordenação dos valores como no exercício "f".
		
		*/
		
		Integer numA = readInteger("Digite um valor para A");
		Integer numB = readInteger("Digite um valor para B");
		Integer numC = readInteger("Digite um valor para C");
		Integer numD = readInteger("Digite um valor para D");
		Integer numE = readInteger("Digite um valor para E");
		
		String auxMensagem = "EXIBIÇÃO DOS VALORES" + "\n"
				+ "Ordem Original: " + numA + "," + numB + "," + numC + "," + numD + "," + numE
				+ "\n" + "Maior valor: "
				+ "\n" + "Menor Valor: ";
		
		if (numA > numB && numA > numC && numA > numD && numA > numE ){
			auxMensagem = auxMensagem ;
		}
		...
		if (numD > numB && numD > numC && numD > numE && numD > numA ){
			auxMensagem = auxMensagem ;
		}
			
		if (numE > numA && numE > numB && numE > numC && numE > numD ){
			auxMensagem = auxMensagem ;
		}
