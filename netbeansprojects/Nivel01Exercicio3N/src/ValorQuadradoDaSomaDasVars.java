...
public class ValorQuadradoDaSomaDasVars {
...
// o valor do quadrado da soma dos três valores lidos.
	...
	Integer a = readWindowInteger("Digite valor de A");
	Integer b = readWindowInteger("Digite valor de B");
	Integer c = readWindowInteger("Digite valor de C");
	
	Integer somavars = a + b + c;
	
	double result = Math.pow(somavars,2);
	
	writeWindow("O valor do Quadrado da soma dos três valores é de: "  + result);
