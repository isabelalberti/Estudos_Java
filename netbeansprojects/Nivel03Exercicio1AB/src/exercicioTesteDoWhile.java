...
public class exercicioTesteDoWhile {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		/* Do significa Faça (pelo menos 1 vez)
		
		Iniciar: 0; terminar: nº digitado -1
		contador
		 */
		Integer qtdEstrelas = readInteger("Quantas estrelas você quer ver?");
		String estrelas = "";
