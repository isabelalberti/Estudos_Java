...
public class exercicio1A_WhilePretty {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		/* Apresente como resultado os quadrados dos números inteiros existentes na faixa
de valores de 15 a 200.
		 */
		Integer cont;
		cont = 15;
		...
		while (cont <= 200) {
// quebra de linha cada 10 numeros e adicionar vírgula
			
			if (contLinha == 10) {
				mensagem += (int) Math.pow(cont, 2) + ", \n";
				contLinha = 1;
				
// não quebrar linha e colocar vírgula

			} else {
				
// remove a vírgula do último elemento
