...
// </editor-fold>
		...
		/*
		Passo 1 : Repetir de 1 a 15
		Passo 2 : Leia quinze valores numéricos inteiros 
		Passo 2 : Fatorar cada valor lido
		...
		Integer contInicio = 1;
		Integer limite = 15;
		
		while (contInicio <= limite) {
			write("Contador: " + contInicio);
