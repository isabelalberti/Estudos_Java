...
public class ExercicioK_While_ParteFinal {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		// Passo 4 - Calcular o somatorio do num grãos total
		// Passo 5 - apresentar esse somatorio.
		Double contTrigo = 1.0;    // não põe 0 porque senão tudo dará 0 devido a multiplicação
		Integer contCasas = 2;     // aqui avancei para segunda casa
		Integer fimCasas = 64;
		Double soma = contTrigo;   // preciso contar casa 1

		while (contCasas <= fimCasas) {
			contTrigo *= 2.0;            // avanço na multiplicação dobrada
			soma = soma + contTrigo;     // acumula cada dobro calculado

			write("Contador Casas " + contCasas + "\nContador Trigos " + contTrigo + "\nSoma Trigo: " + soma);
