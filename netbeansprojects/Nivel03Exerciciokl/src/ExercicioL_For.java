...
public class ExercicioL_For {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		//Passo 3 : Somar o valor total das fatoriais
		// Passo 4 : Apresente o somatório da fatorial de cada valor lido.
		
		Integer limiteNumLido = 15; //original deve ser 15
		Integer numLido = 0;
		Double somaFatorial = 0.0;

		for (int contNumLido = 1; contNumLido <= 15; contNumLido++) {
			...
			if (numLido >= 0) {
				for (int contReversoFatorial = numLido; contReversoFatorial >= limiteFatorial; contReversoFatorial--) {
