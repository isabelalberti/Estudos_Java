...
public class ApresentarValorDoVolume {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
		// Passo 1:  Usuario digitar Raio e Altura
		
		Double raio = readWindowDouble("Digite o valor do raio");
		Double altura = readWindowDouble("Digite o valor da altura");
		Double volume = 3.14159 * raio*raio * altura;
		
		writeWindow("O valor do volume é:" + volume + "m³");
