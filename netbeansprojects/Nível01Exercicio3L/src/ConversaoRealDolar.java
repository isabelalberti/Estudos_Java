...
// </editor-fold>
	...
	// Passo 1: Criar vars Real
		
		Double real = readWindowDouble("Digite o valor em REAL que deseja converter: ");
		
		// Passo 2: Criar vars com cotação do dolar atual
		
		Double cotdolar = 5.29;
	
		
		// Passo 3: Converter a diferenca real em dolar
		
		Double diferenca = (real / cotdolar);
		
			 		
		writeWindow("O valor da quantidade de Real Brasileiro em Dolar Americano é de: " + diferenca);
