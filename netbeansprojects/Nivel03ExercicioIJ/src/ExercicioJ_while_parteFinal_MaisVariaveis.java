...
public class ExercicioJ_while_parteFinal_MaisVariaveis {
...
// </editor-fold>
		...
		/*
		Apresente os valores de conversão de graus Celsius em graus Fahrenheit, de dez
em dez graus.
		Inicie a contagem em dez graus Celsius
		finalizando em cem graus Celsius
		Apresentar os valores das duas temperaturas.
		*/
		
		
		Double celsius = 10.0;
		// termina em 100 celsius
		...
		while (celsius <= 100.0) {
			mensagem = "Valores em Celsius: " + celsius;
			
			fahrenheit =  (9.0 * celsius + 160.0) / 5.0;
			mensagem = mensagem + "\nValores em fahrenheit: " + fahrenheit;
			
			write(mensagem);
			celsius += 10;
		}
		
	// write ele ja exibe a mensagem
	// a string mensagem uso para acumular as mensagem que quero exiber na write 
