...
// o valor da soma dos quadrados dos três valores lidos.
		...
		int a,b,c;
			a = readWindowInteger("Digite valor de A");
			b = readWindowInteger("Digite valor de B");
			c = readWindowInteger("Digite valor de C");
		...
		writeWindow("O valor da soma dos quadrados dos valores é:" + soma );
