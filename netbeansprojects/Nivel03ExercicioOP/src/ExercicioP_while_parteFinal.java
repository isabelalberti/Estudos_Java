...
public class ExercicioP_While_ParteFinal {
...
// </editor-fold>
		...
		Passo 3: Somar os valores pares
		Passo 4: Apresente os resultados da soma desses valores
		 
		 */
		Integer continicio = 50;
		Integer fim = 70;
		Integer resto = 0;
		Double soma = 0.0;
		...
		while (continicio <= 70) {
			resto = continicio % 2;
			if (resto == 0) {
				soma = soma + continicio;
				
				write("Valor " + continicio);

				//write("Inicio" + continicio + "\nResto " + resto + "\nSoma" + soma);
			}
			
			continicio++;
			
		}
		write("O valor da soma de todos os números pares foi de: " + soma);
		// Your code ends here :(
