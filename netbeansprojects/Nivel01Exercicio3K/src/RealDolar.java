...
// </editor-fold>
		...
		// Passo 1: Criar vars Dólar
		
		Double dolar = readWindowDouble("Digite o valor em dolár que deseja converter: ");
		
		// Passo 2: Criar vars com cotação do dolar atual
		
		Double cotdolar = 5.29;
		
		// Passo 3: Converter a diferenca dolar em real
		
		Double diferenca = (dolar * cotdolar);
		
			 		
		writeWindow("O valor da quantidade de Dolar Americano em REAIS é de: " + diferenca);
