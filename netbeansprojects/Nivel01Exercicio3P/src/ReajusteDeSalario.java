...
// </editor-fold>
	...
	// Passo 1: Leia o valor numérico correspondente ao salário mensal (variável SM) de um trabalhador 
	// Passo 2: Faça a leitura do valor do percentual de reajuste (variável PR) a ser atribuído. 
	// Passo 3: Apresentar o valor do novo salário (variável NS).
		
		
	double sm = readWindowDouble("Qual seu salário bruto mensal? ");
	double pr = readWindowDouble("Qual percentual do reajuste salarial? ");
	
	double transpr = (sm * pr) / 100.0;
			
	double result = sm + transpr;
	
	writeWindow("----------------------------------------------------------" +
					"\n O valor do seu novo salário é de: " + result +
                "\n ----------------------------------------------------------");
