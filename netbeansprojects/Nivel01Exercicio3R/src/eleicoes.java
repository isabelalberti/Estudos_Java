...
//PASSO 04: EXIBIR RESULTADOS
		...
		"	Votos válidos: " + totalValidos + "  |  " + percentValidosTotal + "%" + "\n" +
		"	Votos Nulos:  " + nulos + "  |  " + percentNulosTotal + "%" + "\n" +
		"	Votos Brancos:  " + brancos + "  |  " + percentBrancosTotal + "%" + "\n" +
		"	\n" +
		"	\n" +
		"	Candidato A\n" +
		"	Votos válidos: " + validoA + "  |  " + percentValidoA + "%" + "\n" +
		"	\n" +
		"	Candidato B\n" +
		"	Votos válidos: " + validoB + "  |  " + percentValidoB + "%" + "\n" +
		"	\n" +
		"	Candidato C\n" +
		"	Votos válidos: " + validoC + "  |  " + percentValidoC + "%" + "\n"
		);
