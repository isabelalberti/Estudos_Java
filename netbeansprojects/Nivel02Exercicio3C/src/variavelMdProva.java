...
// </editor-fold>
		...
		/*
Passo 1: Leitura dos valores de 4 notas escolares bimestrais de um aluno (vars N1, N2, N3 e N4)
		
Passo 2: Calcular a média aritmética (variável MD) desse aluno 
		
Passo 3: Apresentar a mensagem 
			"Aprovado" se a média obtida for maior ou igual a 5;
				caso contrário, apresentar a mensagem "Reprovado".
		
Passo 4: Informar também, após a apresentação das mensagens, 
			o valor da média obtida pelo aluno.
		*/
		
		Double n1 = readDouble("Digite sua primeira nota");
		Double n2 = readDouble("Digite sua segunda nota");
		Double n3 = readDouble("Digite sua terceira nota");
		Double n4 = readDouble("Digite sua quarta nota");
		
		Double sn = n1 + n2 + n3 + n4;
