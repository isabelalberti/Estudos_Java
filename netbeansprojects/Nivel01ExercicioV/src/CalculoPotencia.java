...
// </editor-fold>
		...
		// Passo 1: Leia dois valores numéricos inteiros, 
		// Passo 2: Devem representar a base e o expoente de uma potência, 
		// Passo 3: Calcule a potência e 
		// Passo 4: Apresente o resultado obtido.
		// Atenção: A potência é calculada multiplicando o número base por ele mesmo quantas vezes o expoente mandar.
		
		
		Integer base, expoente;
		base = readWindowInteger("Digite o valor da Base");
		expoente = readWindowInteger("Digite o valor do expoente");
				
		Double pot = Math.pow(base, expoente);
		
		writeWindow("O resultado da exponenciação é: " + pot);
