...
// </editor-fold>
		...
		/*
		Passo 1: Ler três valores inteiros representados pelas variáveis A, B e C 
		
		Passo 2: Apresentar os valores lidos dispostos em ordem crescente. 
		
		Atenção: Utilizar tomada de decisão sequencial e as ideias trabalhadas 
		nos exercícios "g" (propriedade distributiva) 
		e "f" (troca de valores) do capítulo 3.
		
		Comparar num1 com num2, se num2 for maior, invertemos os valores. 
		Comparar num1 com num3, se num3 for maior, invertemos os valores. 
		Agora temos num2 e num3, se num3 for maior, devemos inverter os valores,
