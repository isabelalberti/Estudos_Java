...
public class QuadradoDaDivisão {
...
//  Passo 1: Ler dois valores numéricos inteiros (representados pelas variáveis A e B)
//  Passo 2: Calcular o valor da divisão do primeiro valor em relação ao segundo valor.
//  Passo 2: Calcular o valor do Quadrado da divisão do primeiro valor em relação ao segundo valor		
//  Passo 3: Apresentar o resultado do quadrado da divisão do primeiro valor em relação ao segundo valor 
		
		Integer a = readWindowInteger("Digite um valor");
		Integer b = readWindowInteger("Digite mais um valor" );
		
		Integer div = a / b;
		
		Double quad = Math.pow(div, 2);
		
		writeWindow("O Resultado Final é: " + quad);
