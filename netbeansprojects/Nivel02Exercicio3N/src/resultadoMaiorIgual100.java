...
public class resultadoMaiorIgual100 {
...
// </editor-fold>
		...
		Somar os valores fornecidos 
		Apresentar o resultado somente se for maior ou igual a 100.
		*/
		
		Integer valorA = readInteger("Digite valor para A");
		Integer valorB = readInteger("Digite valor para B");
		Integer valorC = readInteger("Digite valor para C");
		
		Integer somaABC = valorA + valorB + valorC;
