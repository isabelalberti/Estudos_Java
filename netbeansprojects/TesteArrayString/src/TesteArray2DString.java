...
public class TesteArray2DString {
...
// </editor-fold>
	...
	String mensagem = "";
		...
		for (int indiceN1 = 0; indiceN1 < nomes.length; indiceN1++) {
			for (int indiceN2 = 0; indiceN2 < nomes[indiceN1].length; indiceN2++) {
				nomes[indiceN1][indiceN2] = readString("Digite seu nome");
				mensagem += nomes[indiceN1][indiceN2] + ", ";
		}
