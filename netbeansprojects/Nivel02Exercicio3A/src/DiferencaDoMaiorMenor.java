...
public class DiferencaDoMaiorMenor {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
/* Passo 1: Leitura de duas variáveis inteiras
   Passo 2: Calcular a diferença do maior valor pelo menor valor
   Passo 3: Apresentar o resultado dessa diferença. 
*/
		
		Integer valorA = readWindowInteger("Digite um valor para A");
		Integer valorB = readWindowInteger("Digite um valor para B");
		...
		writeWindow("A diferença do maior valor pelo menor é: " + result );
