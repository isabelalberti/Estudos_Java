...
// </editor-fold>
	...
	Passo 1: Leia oito elementos inteiros 
	Atenção: em uma matriz A do tipo vetor
		
	Passo 2: Multiplicar por 3 os elementos da matriz A.
	Passo 3: Construir uma matriz B de mesma dimensão com os elementos da matriz A
	
	Atenção: O elemento B[1] deve ser implicado pelo elemento A[1] * 3, 
	o elemento B[2] implicado pelo elemento A[2] * 3 
	e assim por diante, até 8.
		
	Passo 4 : Apresentar a matriz B. 
		
		*/
		
		// todo array começa do zero, pq o pc começa a contar do zero.
		
		Integer [] numsA = new Integer [8];
		Integer [] numsB = new Integer [8];
		String mensagem = "";
		
		// RECEBENDO OITO ELEMENTOS		
		for (int indice = 0; indice < numsA.length; indice++){
		numsA[indice]= readInteger("Digite um valor");
		}
		
		// MULTIPLICANDO ELEMENTOS DO 4 E JOGAR NO B
		for (int indice = 0; indice < numsA.length; indice++) {
			numsB[indice] = numsA[indice]*3;
		...
		// Mostrando o array B
			write("Os valores dos elementos de B são: \n" + mensagem);
