...
public class ResultadoAreaCircunferencia {
...
// </editor-fold>
		...
		// Passo 1: Solicitar a entrada do valor do raio da circunferência (variável R).
		// Passo 2: Calcule o valor do resultado da área de uma circunferência (variável A). 
		// Passo 3: Apresente o valor do resultado da área de uma circunferência (variável A). 
		// Passo 4: Utilize a fórmula A ← 3.14159265* R ↑ 2.
		
		int raio = readWindowInteger("Digite o valor do RAIO da circunferência");
		
		double arearesult = Math.PI * Math.pow(raio, 2);
		
		writeWindow("O valor da Área da Circunferência é de:" + arearesult);
