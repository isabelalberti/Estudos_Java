...
// </editor-fold>
		...
		/*
		Leia seis elementos (valores inteiros) para as matrizes A e B de uma dimensão do tipo vetor. 
		
		Construir as matrizes C e D de mesmo tipo e dimensão. 
		
		Matriz C deve ser formada pelos elementos de índice ímpar das matrizes A e B
		
		Matriz D deve ser formada pelos elementos de índice par das matrizes A e B. 
		...
		*/
		...
		Integer [] par = new Integer[tamanho*2];
		Integer [] impar = new Integer[tamanho*2];
		...
		for (int indice = 0; indice < arrayA.length; indice++) {
			if (arrayA[indice] % 2 == 0) {
				par[indicePar] = arrayA[indice];
				indicePar++;
			}
			else{
				impar[indiceImpar] = arrayA[indice];
				indiceImpar++;
			}
			
			if (arrayB[indice] % 2 == 0) {
				par[indicePar] = arrayB[indice];
				indicePar++;
			}
			else{
				impar[indiceImpar] = arrayB[indice];
				indiceImpar++;
			}
		}
		...
		for (int i = 0; i < impar.length; i++) {
				if (impar[i] != null) {
				System.out.println("Os elementos do array PAR: " + par[i] + "\n" + "Os elementos do array IMPAR: " + impar[i]);
			}
				if (par[i] != null) {
				System.out.println("Os elementos do array PAR: " + par[i] + "\n" + "Os elementos do array IMPAR: " + impar[i]);
			}
