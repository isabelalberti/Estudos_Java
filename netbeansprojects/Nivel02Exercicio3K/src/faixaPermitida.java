...
// </editor-fold>
		...
		/*
Ler um valor numérico inteiro que esteja na faixa de valores de 1 até ́9.
Apresentar a mensagem "O valor está ́na faixa permitida", 
		- caso o valor informado esteja entre 1 e 9.
Se o valor estiver fora da faixa, apresentar a mensagem "O valor está fora da faixa permitida".
		*/
		
		Integer num = readInteger("Digite um valor de 1 a 9.");
		String mensagem = "O valor está ́na faixa permitida";
		...
		if (num != 9) {
				write("O valor está fora da faixa permitida");
		}
