...
// </editor-fold>
		...
		Passo 1 : Leia duas matrizes (denominadas A e B) do tipo vetor com 20 elementos reais.
		
		Passo 2: Cada elemento da matriz C é a subtração de um elemento correspondente da matriz A com um elemento correspondente da matriz B,
		Atenção: A operação de processamento deve estar baseada na operação C[I] ← A[I] - B[I]. 
		
		Passo 3: Construir uma matriz C,
		Passo 4: Apresentar os elementos da matriz C. 		
		
		*/
		
		Integer [] numsA = new Integer [20];
		Integer [] numsB = new Integer [20];
		Integer [] numsC = new Integer [20];
		String mensagem = "";
		...
		for (int indice = 0; indice < numsC.length; indice++) {
			numsC [indice] = numsA[indice] - numsB[indice];
			mensagem += numsC[indice] + ", ";
		}
		
		write("Os valores dos elementos de C são: \n" + mensagem);
