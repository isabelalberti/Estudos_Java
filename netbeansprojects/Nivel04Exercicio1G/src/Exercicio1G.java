...
// </editor-fold>
		...
		/*
		Passo 1: Leia duas matrizes do tipo vetor para o armazenamento de nomes de pessoas,
		a matriz A com 20 elementos 
		a matriz B com 30 elementos
		a matriz C a junção das matrizes A e B, deve ter a capacidade de armazenar 50 elementos.
		Apresentar os elementos da matriz C. 
		*/
		
		Integer [] numsA = new Integer [2];
		Integer [] numsB = new Integer [3];
		Integer [] numsC = new Integer [5];
		String mensagem = "";
