...
// </editor-fold>
		...
		/*
		Leia 15 elementos reais para uma matriz A de uma dimensão do tipo vetor. 
		
		Construir uma matriz B de mesmo tipo e dimensão
		
		"todo elemento da matriz A que possuir índice par deve ter seu elemento dividido por 2;
		caso contrário, o elemento da matriz A deve ser multiplicado por 1.5". 
		...
		*/
		...
		for (int i = 0; i < 15; i++) {
			arrayA[i] = readDouble("Digite um valor para A");
		...
		for (int i = 0; i < arrayA.length; i++) {
				System.out.println("Os valores da matriz B: \n ["+ i +"]: " + arrayB[i]);
		}
