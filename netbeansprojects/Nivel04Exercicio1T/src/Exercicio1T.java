...
// </editor-fold>
		...
		/*
		Leia duas matrizes A e B de uma dimensão com dez elementos. 
		
		A matriz A deve aceitar apenas a entrada de valores divisíveis por 2 e 3, 
		Enquanto a matriz B deve aceitar apenas a entrada de valores múltiplos de 5. 
		Construir uma matriz C que seja o resultado da junção das matrizes A e B, de modo que contenha 20 elementos. 
