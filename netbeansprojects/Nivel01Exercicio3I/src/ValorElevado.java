...
// </editor-fold>
		...
		/*
		Ler um valor numérico inteiro 
		Apresentar o resultado do valor lido elevado ao quadrado.
		*/
		
		Integer vn = readInteger("Digite um valor numérico inteiro: ");
		
		Double result = Math.sqrt(vn);
		
		write("A Raiz Quadrada obtida é: " + result);
