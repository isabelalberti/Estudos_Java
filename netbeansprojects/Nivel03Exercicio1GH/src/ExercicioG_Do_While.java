...
public class ExercicioG_Do_While {
...
// </editor-fold>
		...
		/*
		Apresente os resultados das potências do valor de base 3, elevado a um
expoente que varie do valor 0 até o valor 15. 
		
		Atenção: O programa deve apresentar os valores 1, 3, 9, 27, ...,14.348.907. 
		
		Sugestão: leve em consideração as definições matemáticas do cálculo de potência, em que
qualquer valor numérico diferente de zero elevado a zero é 1, e todo valor numérico elevado a 1 é ele
próprio. 
