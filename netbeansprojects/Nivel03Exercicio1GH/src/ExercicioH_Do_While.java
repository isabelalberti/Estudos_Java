...
public class ExercicioH_Do_While {
...
// </editor-fold>
		...
		/*
		Apresente como resultado a potência de uma base qualquer elevada a um expoente qualquer, 
		
		Considere apenas a entrada de valores inteiros e positivos, ou seja, de valores naturais. 
		
			 */
		
		Integer base = readInteger ("Digite um valor inteiro para Base");
		Integer exp = readInteger("Digite um valor para Expoente");
		Double result = 1.0;
		Integer cont = 0;
