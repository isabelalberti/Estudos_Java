...
// </editor-fold>
		...
		/*
		Fazer a leitura de um valor numérico inteiro qualquer 
		Apresentá-lo caso não seja maior que 3. 
		
		Atenção: para a solução deste problema utilize apenas o operador lógico de negação.

		*/
		
		Integer num1 = readInteger("Digite um valor numérico inteiro");
