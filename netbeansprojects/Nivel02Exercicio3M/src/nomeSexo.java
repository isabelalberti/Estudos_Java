...
// </editor-fold>
		...
		/*
		Ler um nome (variável NOME)
		Ler sexo (variável SEXO) de uma pessoa 
		Apresentar uma das seguintes mensagens: "Ilmo. Sr.",
		caso seja informado o sexo masculino 
		(utilizar como valor o caractere "M"),
		ou "Ilma. Sra.", caso seja informado o sexo feminino 
		(utilizar como valor o caractere "F").
Atenção: Após a mensagem de saudação, apresentar o nome informado.
		Após a entrada do sexo, 
		(verificar se o sexo fornecido é igual a "M" ou a "F")
		Não sendo essa condição verdadeira,
		o programa deve apresentar a mensagem "Sexo informado inválido".
		*/
		
		String nome = readString("Digite seu nome");
		
		String sexo = readString("Qual seu sexo: " + "\n"
				+ "Coloque F para Feminino e M para Masculino ");
