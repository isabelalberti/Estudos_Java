...
public class ValorVolume02 {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
		Double comprimento = readWindowDouble("Digite o valor do COMPRIMENTO da caixa");
		Double largura = readWindowDouble("Digite o valor da LARGURA da caixa");
		Double altura = readWindowDouble("Digite  valor da ALTURA da caixa");
		
		Double volume = comprimento * largura * altura;
		
		writeWindow("O valor do VOLUME da caixa é de : " + volume);
