...
// </editor-fold>
		...
		//Passo 1: Leia uma matriz A do tipo vetor com dez elementos inteiros. 
		...
		for (int i = 0; i < 10; i++) {
			arrayA[i]= readInteger("Digite o " + (i+1) + "º para A");
		// Passo 3: Cada elemento deve ser a metade exata de cada um dos elementos existentes da matriz A
			arrayB[i]= arrayA[i]/2;
		}
