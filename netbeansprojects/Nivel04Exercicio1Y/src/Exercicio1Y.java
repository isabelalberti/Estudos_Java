...
// </editor-fold>
		...
		/*
		Leia uma matriz A de uma dimensão com 15 elementos numéricos inteiros. 

		Apresentar o total de elementos pares existentes na matriz.

		*/
		
		Integer[] arrayA = new Integer[3];
		Integer qtdPar = 0;
