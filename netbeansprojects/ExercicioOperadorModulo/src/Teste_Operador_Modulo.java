...
public class Teste_Operador_Modulo {
...
// </editor-fold>
		...
		/*
		Tendo-se em mente que toda divisão tem um dividendo, um divisor
		e um quociente; o operador módulo (simbolo %) não foge dessa regra 
		tendo apenas como diferença o valor do quociente que vem a ser o resto da divisão.
		Agora faça um programa que leia o divisor do usuário e exiba o quociente das
		sucessivas divisões entre a faixa numérica de 0 a 100.
		*/
		
		Integer dividendo = 0;
		Integer divisor = readInteger("Digite um valor para divisor");
		...
		while (dividendo <= fim) {
			...
			// quocienteResto = dividendo / divisor, não usei o simbola da divisão
			// porque quero somente o resto, por isso o módulo.
