...
// </editor-fold>
		...
		writeWindow("Modelo 2");
	int a,b;
			a = readWindowInteger("Digite um valor para A");
			b = readWindowInteger("Digite um valor para B");
			
	int diferenca = a-b;
	
	double quadradodiferenca = Math.pow(diferenca, 2);
	
	int result = (int) quadradodiferenca;
	
		writeWindow("Resultado do Quadrado da Diferença: " + result);
