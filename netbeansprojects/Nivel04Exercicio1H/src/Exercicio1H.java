...
// </editor-fold>
		...
		/*
		Passo 1: Leia 20 elementos do tipo real em uma matriz A unidimensional 
		
		Passo 2: Construir uma matriz B de mesma dimensão 
		
		Passo 3: Inverter os elementos
		Atenção: com os mesmos elementos armazenados na matriz porém de forma invertida. 
		
		Ou seja, o primeiro elemento da matriz A passa a ser o último da matriz B.
		Passo 4: Apresentar os elementos das matrizes A e B. 
		*/
		
		Integer[] numsA = new Integer[2];
		Integer[] numsB = new Integer[2];
		String mensagem = "";
		...
		for (int indice = numsB.length -1; indice >= 0;indice--) {
		...
		write("Os valores da matriz B são: " + mensagem);
