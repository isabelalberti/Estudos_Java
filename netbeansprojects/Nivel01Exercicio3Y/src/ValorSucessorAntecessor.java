...
public class ValorSucessorAntecessor {
...
// </editor-fold>
		...
		// Passo 1: Leia um valor numérico inteiro
		// Passo 2: Calcule seus valores sucessor e antecessor
		// Passo 3: Apresente os resultados dos valores
		
		int num = readWindowInteger("Digite um valor de 0 a 999");
		int suc = num + 1;
		int ant = num - 1;
		
		writeWindow("O número que ANTECEDE o seu é: " + ant +
				"\n e o número que SUCEDE o seu é:" + suc );
